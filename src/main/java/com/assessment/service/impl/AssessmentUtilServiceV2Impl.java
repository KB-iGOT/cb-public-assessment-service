...
public class AssessmentUtilServiceV2Impl implements AssessmentUtilServiceV2 {
	...
	public Map<String,Object> fetchHierarchyFromAssessServc(String qSetId){
			Map<String, Object> readHierarchyApiResponse = getReadHierarchyApiResponse(qSetId);
	...
	public Map<String, Object> readAssessmentHierarchyFromCache(String assessmentIdentifier,boolean editMode) {
		...
		if(editMode)
		return fetchHierarchyFromAssessServc(assessmentIdentifier);
	...
	public Map<String, Object> readQListfromCache(List<String> questionIds, String assessmentIdentifier,boolean editMode) throws IOException {
		if (serverProperties.qListFromCacheEnabled())
			return qListFromCache(assessmentIdentifier,editMode);
		else
	...
	public Map<String, Object> qListFromCache(String assessmentIdentifier,boolean editMode) throws IOException {
		...
		if (StringUtils.isEmpty(questStr)) {
			...
			Map<String, Object> assessmentData = readAssessmentHierarchyFromCache(assessmentIdentifier,editMode);
